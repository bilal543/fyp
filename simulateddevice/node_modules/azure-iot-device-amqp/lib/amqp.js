...
var Amqp = /** @class */ (function (_super) {
        ...
        _this._fsm = new machina.Fsm({
            ...
            states: {
                disconnected: {
                    ...
                    sendTwinRequest: function (method, resource, properties, body, sendTwinRequestCallback) {
                        _this._fsm.handle('connect', function (err, result) {
                            if (err) {
                                sendTwinRequestCallback(err);
                            }
                            else {
                                _this._fsm.handle('sendTwinRequest', method, resource, properties, body, sendTwinRequestCallback);
                            }
                        });
                    },
                ...
                authenticated: {
                    ...
                    getTwinReceiver: function (callback) {
                        ...
                        callback(null, _this._twinClient);
                    },
                    sendTwinRequest: function (method, resource, properties, body, sendTwinRequestCallback) {
                        _this._twinClient.sendTwinRequest(method, resource, properties, body, sendTwinRequestCallback);
                    },
                    enableC2D: function (callback) {
                    ...
                    enableTwin: function (callback) {
                        ...
                        /*Codes_SRS_NODE_DEVICE_AMQP_16_047: [The `enableTwin` method shall call its `callback` with an `Error` if the transport fails to connect, authenticate or attach twin links.]*/
                        _this._twinClient.attach(callback);
                    },
                    disableTwin: function (callback) {
                        ...
                        _this._twinClient.detach(callback);
                    }
                },
                disconnecting: {
    ...
    Amqp.prototype.sendTwinRequest = function (method, resource, properties, body, done) {
        this._fsm.handle('sendTwinRequest', method, resource, properties, body, function (err) {
            if (done) {
                done(err);
            }
        });
     ...
     * @private
     */
    Amqp.prototype.enableTwin = function (callback) {
        this._fsm.handle('enableTwin', callback);
    };
    /**
     * @private
     */
    Amqp.prototype.disableTwin = function (callback) {
